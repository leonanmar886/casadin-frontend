...
export default function TestPaymentPage() {
  ...
  const sampleGifts = [
    {
      ...
      price: 299.99,
      image: "data:image/svg+xml;base64,"
    },
    {
      id: 2,
  ...
  const handlePaymentSuccess = (giftId: number) => {
    // Pagamento realizado com sucesso para o presente
  };
